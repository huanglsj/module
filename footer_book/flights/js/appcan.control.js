...
appcan.extend(function(a, b, c) {
    ...
    function l(a, b) {
        d("select",d(a))[0].selectedIndex = -1;
        var c = d(a).find("div[class=text]"),
            e = d(a).find("select"),
            f = e.find("option"),
            g = parseInt(e.attr("selectedIndex"));
        -1 != g && c.html(e[0].options[g].text), d("select", d(a)).on("change", function(a) {
